...
namespace PdfInvoices\Symfony\DependencyInjection;
...
use PdfInvoices\Symfony\Translation\SymfonyTranslator;
...
final class PdfInvoicesExtension extends Extension
{
    ...
    {
        $container->setParameter('pdf_invoices.default_template', $configs[0]['template'] ?? 'modern');
        ...
        $container->setDefinition('pdf_invoices.template_resolver', new Definition(FilesystemTemplateResolver::class, [[
            dirname(__DIR__, 4) . '/core/resources/templates',
        ]]));
